...
public class MeshDestroy : MonoBehaviour
{
    ...
    public int numberOfCoinsAfterDestroy;
    public GameObject coin;
    private GameObject[] generatedGameObjects;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "S_car") {
            ...
            StartCoroutine(DestroyGeneratedGameObjects());

            for(int i = 0;i<=numberOfCoinsAfterDestroy;i++) Instantiate(coin, transform.position, Quaternion.identity);
    ...
    IEnumerator DestroyGeneratedGameObjects()
    {
        yield return new WaitForSeconds(2.0f);
        generatedGameObjects = GameObject.FindGameObjectsWithTag("CuboTemp");
        yield return new WaitForSeconds(0.5f);
        foreach (GameObject i in generatedGameObjects)
        {
